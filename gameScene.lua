...
function scene:enterScene(inEvent)
	...
	function gameListeners(action)
		...
		--gc.gameBg1:addEventListener('touch', movePlayer)
			...
			--gc.gameBg.enterFrame = platformScroller
			--Runtime:addEventListener("enterFrame", gc.gameBg)

			--gc.gameBg1.enterFrame = platformScroller
			--Runtime:addEventListener("enterFrame", gc.gameBg1)
		else
	...
	function platformScroller(self,event)
		...
		if self.x < (-900 + (self.speed*4)) then
			self.x = 900
		else 
